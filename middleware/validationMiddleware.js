...
export const validateFirearmsInput =
  withValidationErrors([
    ...
    body('caliber')
      ...
      .withMessage(
        `Caliber must be one of: ${Object.values(
          FIREARMS_CALIBER
        ).join(', ')}`
      ),
    body('model')
      ...
      .withMessage(
        `Model must be one of: ${Object.values(
          FIREARMS_MODEL
        ).join(', ')}`
      ),
    body('manufacturer')
      ...
      .withMessage(
        `Manufacturer must be one of: ${Object.values(
          FIREARMS_MANUFACTURER
        ).join(', ')}`
      ),
    body('price')
    ...
    body('type')
      ...
      .withMessage(
        `Type must be one of: ${Object.values(
          FIREARMS_TYPE
        ).join(', ')}`
      ),
  ]);
